 <!-- ##### Breadcumb Area Start ##### -->
    <section class="breadcumb-area bg-img" style="background-image: url(<?=base_url();?>libraries/img/bg-img/hero1.jpg);">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="single-listings-sliders owl-carousel">
                        <!-- Single Slide -->
                        <img src="/<?=base_url();?>libraries/img/bg-img/hero4.jpg" alt="">
                        <!-- Single Slide -->
                        <img src="<?=base_url();?>libraries/img/bg-img/hero5.jpg" alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8">
                    <div class="listings-content">
                        ...
                        <p class="location"><img src="<?=base_url();?>libraries/img/icons/location.png" alt="">Upper Road 3411, no.34 CA</p>
                        ...
                        <div class="property-meta-data d-flex align-items-end">
                            ...
                            <div class="bathroom">
                                <img src="<?=base_url();?>libraries/img/icons/bathtub.png" alt="">
                                <span>2</span>
                            </div>
                            <div class="garage">
                                <img src="<?=base_url();?>libraries/img/icons/garage.png" alt="">
                                <span>2</span>
                            </div>
                            <div class="space">
                                <img src="<?=base_url();?>libraries/img/icons/space.png" alt="">
                                <span>120 sq ft</span>
                            </div>
                        </div>
                        <!-- Core Features -->
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="contact-realtor-wrapper">
                        <div class="realtor-info">
                            <img src="<?=base_url();?>libraries/img/bg-img/listing.jpg" alt="">
                            <div class="realtor---info">
                                <h2>Jeremy Scott</h2>
                                <p>Realtor</p>
                                <h6><img src="<?=base_url();?>libraries/img/icons/phone-call.png" alt=""> +45 677 8993000 223</h6>
                                <h6><img src="<?=base_url();?>libraries/img/icons/envelope.png" alt=""> office@template.com</h6>
                            </div>
