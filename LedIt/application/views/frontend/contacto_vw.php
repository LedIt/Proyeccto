                ...
                <div class="col-12 col-lg-8">
                    <div class="contact-form wow fadeInUp" data-delay="400ms">
                        <form id="default-behavior" action="<?=base_url().'Contactos/nuevoContacto';?>" method="POST">
                            ...
                            <div class="wrap-input100 col-lg-10 col-md-10">
                                <input class="input100" type="text" name="nombre_Contacto" data-validate="validate(required, text, minlength(3))" autofocus>
                                <span  class="focus-input100" data-placeholder="Nombre completo"></span>
                            </div>

                            <div style="margin-left: 2%;" class="row">

                                <div  class="wrap-input100 col-lg-5 col-md-5">
                                    <input class="input100" type="text" name="telefono_Contacto" data-validate="validate(required, number, minlength(10))">
                                    <span  class="focus-input100" data-placeholder="Teléfono"></span>
                                </div>

                                    <div class="col-lg-1 col-md-1"></div>

                                 <div style="margin-left: 4%;" class="wrap-input100 col-lg-5 col-md-5">
                            ...
                            <div  class="wrap-input100 validate-input">
                                <textarea class="input100" type="text" name="mensaje_Contacto" placeholder="Mensaje" data-validate="validate(required, text, minlength(3))"></textarea>
