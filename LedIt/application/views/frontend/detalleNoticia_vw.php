 <!-- ##### Breadcumb Area Start ##### -->
    <section class="breadcumb-area bg-img" style="background-image: url(/LedIt/template/img/bg-img/hero1.jpg);">
                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="single-blog-area">
                        ...
                        <div class="blog-post-thumbnail">
                            <img src="/LedIt/template/img/blog-img/blog3.jpg" alt="">
                        </div>
                        <!-- Post Content -->
                        ...
                        <ol>
                            ...
                            <li class="single_comment_area">
                                <div class="comment-wrapper d-flex">
                                    ...
                                    <div class="comment-author">
                                        <img src="/LedIt/template/img/blog-img/c-1.jpg" alt="">
                                    </div>
                                    <!-- Comment Content -->
                            ...
                            <li class="single_comment_area">
                                <div class="comment-wrapper d-flex">
                                    <!-- Comment Meta -->
                                    <div class="comment-author">
                                        <img src="/LedIt/template/img/blog-img/c-3.jpg" alt="">
                                    </div>
                                    <!-- Comment Content -->
                                    <div class="comment-content">
                                        <div class="comment-meta">
                        ...
                        <div class="featured-properties-slides owl-carousel">
                            ...
                            <div class="single-featured-property">
                                ...
                                <div class="property-thumb">
                                    <img src="/LedIt/template/img/bg-img/feature1.jpg" alt="">
                                ...
                                <div class="property-content">
                                    ...
                                    <div class="property-meta-data d-flex align-items-end justify-content-between">
                                        <div class="new-tag">
                                            <img src="/LedIt/template/img/icons/new.png" alt="">
                                        </div>
                                        <div class="bathroom">
                                            <img src="/LedIt/template/img/icons/bathtub.png" alt="">
                                            <span>2</span>
                                        </div>
                                        <div class="garage">
                                            <img src="/LedIt/template/img/icons/garage.png" alt="">
                                            <span>2</span>
                                        </div>
                                        <div class="space">
                                            <img src="/LedIt/template/img/icons/space.png" alt="">
                                            <span>120 sq ft</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="single-featured-property">
                                <!-- Property Thumbnail -->
                                <div class="property-thumb">
                                    <img src="/LedIt/template/img/bg-img/feature2.jpg" alt="">
