           ...
           <!-- user image section-->
                        <div class="user-section">
                            ...
                            <div class="user-info">
                                ...
                                <div style="margin-top: 15%;" class="user-text-online">
   ...
   <table class="table table-bordered">
            ...
            <tr>
                ...
                <td width="40%">
                        ...
                        <td id="eliminar"><?= anchor('../index.php/Productos_controller/eliminarProd/' . $items['rowid'], 'Eliminar') ?><span class="glyphicon glyphicon-trash"></span>
                        </td>
                </tr>
